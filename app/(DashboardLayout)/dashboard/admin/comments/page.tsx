...
export default function Comments() {
  ...
  const { data: reviewsRes, isLoading, refetch } = useAllUserReviewsQuery({});
  ...
  const handleStatusChange = async (
    ...
    try {
      const result = await updateReviewStatus({ id, status }).unwrap();
      toast.success(result?.message || "Review status updated");
      refetch();
    } catch (error: any) {

...
export default function Error({
  ...
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center bg-[var(--background)] px-6 text-center">
      ...
      <p className="max-w-md text-sm font-medium opacity-50 mb-10 leading-relaxed uppercase tracking-wide">
       ...
       <div className="flex flex-col sm:flex-row items-center gap-4">
        ...
        <Link
          href="/"
          className="flex items-center gap-2 bg-[var(--muted)] px-8 py-4 rounded-2xl font-black uppercase text-xs tracking-widest border border-[var(--border)] hover:bg-white hover:text-black transition-all"
        >
       ...
       {error.digest && (
        <span className="mt-12 text-[8px] font-mono opacity-20 uppercase tracking-widest">
